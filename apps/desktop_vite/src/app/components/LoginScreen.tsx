...
type RegistrationRole = UserRole | 'both';
...
const STATE_OPTIONS: ReadonlyArray<{ code: string; name: string }> = [
...
function validateRegisterForm(data: RegisterFormData): Partial<Record<RegisterField, string>> {

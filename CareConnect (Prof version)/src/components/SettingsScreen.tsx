        ...
        <SettingCard title="Text Size">
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full min-h-[56px] bg-[#3A3A3A] text-white font-bold text-xl rounded-xl px-6 py-4 transition-opacity hover:opacity-90"
        ...
        <SettingCard title="Voice Features">
          <div className="space-y-3">
            <button
              ...
              className="w-full min-h-[56px] bg-[#00E600] text-[#0B0B0B] font-bold text-xl rounded-xl px-6 py-4 transition-opacity hover:opacity-90 flex items-center justify-between"
            ...
            <button
              ...
              className="w-full min-h-[56px] bg-[#3A3A3A] text-white font-bold text-xl rounded-xl px-6 py-4 transition-opacity hover:opacity-90 flex items-center justify-between"
